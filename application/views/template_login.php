...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>aceadmin/assets/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />
        ...
        <!--[if lte IE 9]>
            ...
            <!-- <link rel="stylesheet" href="<?= base_url(); ?>aceadmin/assets/css/style.css"/> -->
        </head>

        <body class="login-layout" class="no-skin">
                            ...
                            <div class="login-container">
                                <div class="center">
                                    <h1>
                                        ...
                                        <span class="red">RKAPe</span>
                                        <span class="white" id="id-text2">Application</span>
                                    </h1>
                                    <h4 class="blue" id="id-company-text">&copy; Petik 2018</h4>
                                </div>
                                                ...
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            <input name="username" type="text" class="form-control" placeholder="Username" required value="<?= set_value('username') ?>" />
